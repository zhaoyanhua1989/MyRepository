...
{
	public class ChannelUtils : MonoBehaviour{
	...
	public class DialogHelper:MonoBehaviour
	{
		...
		public void showCallbackTip(string tip)
		{
			...
			GameObject uiRootObject = GameObject.Find ("ChannelTestWindow");//how to find root
			...
			StartCoroutine(ChannelUtils.hideDialog(2.0f,dialog));
		}
		...
		public void showQuitConfirmDialog()
		{
			if(confirmDialog == null)
			{
				...
				GameObject uiRootObject = GameObject.Find ("ChannelTestWindow");
