...
public class UpdateService {
	 ...
	 * @param url
	 */
	private boolean checkDownLoadTask(String url) {
		final HashMap<String, Boolean> returnHM = new HashMap<String, Boolean>();
